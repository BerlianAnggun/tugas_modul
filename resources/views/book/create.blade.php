                                        ...
                                        <form method="post" action="{{ route('book.store') }}"
                                            ...
                                            <div class="max-w-xl">
                                                ...
                                                <x-text-input id="author" type="text" name="author"
                                                    class="mt-1 block w-full" value="{{ old('author') }}" required />
                                            ...
                                            <div class="max-w-xl">
                                                ...
                                                <x-text-input id="year" type="number" name="year"
                                                    class="mt-1 block w-full" value="{{ old('year') }}" required />
                                            ...
                                            <div class="max-w-xl">
                                                ...
                                                <x-text-input id="quantity" type="number" name="quantity"
                                            ...
                                            <x-secondary-button tag="a"
                                                href="{{ route('books') }}">Cancel</x-secondary-button>
                                            <x-primary-button name="save_and_create" value="true">Save & Create
                                                Another</x-primary-button>
...
od="post" action="{{ route('book.store') }}" enctype="multipart/form-data"
